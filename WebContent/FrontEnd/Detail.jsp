...
<body>
    ...
    <div id="header">
        <ul>
            ...
            <li class="heart_none"><input type="image" name="heart_none" src="image/heart_none.png"></li>
            <li class="heart"><input type="image" name="heart" src="image/heart.png"></li>
        </ul>
    </div>
    ...
    <div id="content">
        ...
        <div class="summary">
            ...
            <div class="size">
                <p>사이즈</p>
                <div class="size_area">
                    <button class="btn_size">76</button>
                    <button class="btn_size">82</button>
                    <button class="btn_size">88</button>
                </div>
            </div>
        </div>

        <div class="explanation">
            <p class="item_txt">여유로운 실루엣의 탑입니다. 슬리브와 이어지는 앞뒤 상단의 프릴 패널과 프런트 상단의 셔링 봉제로 한층 페미닌한 무드가 느껴집니다. 번아웃 텍스처의 전체 프린팅 디자인으로 화려하며, 슬리브를 제외하고 안감을 봉제하여 착용감이 좋습니다. 제품과 동일한 프린팅의 스커트와 셋업하여 연출할 수 있습니다.
            <br>
            <br>
            - 백 넥라인의 콘솔 지퍼로 여미는 방식이며, 프릴넥 디자인
            <br>
            - 소맷단에 버튼으로 고정 가능한 슬릿이 있으며, 프릴 마감
            <br>
            <br>
            - 피팅 정보 : 173cm, 55 사이즈 모델이 82 사이즈 착용
            </p>
            ...
            <div class="collapse-item">
                ...
                <div id="content2" class="con">
                    <div class="snap clear">
                        <p>
                            <span>키</span>
                            <input type="number" name="키">
                        </p>
                        <p>
                            <span>몸무게</span>
                            <input type="number" name="몸무게">
                        </p>
                        <p>
                            <span>허벅지</span>
                            <input type="number" name="허벅지">
                        </p>
                        <p>
                            <span>허리둘레</span>
                            <input type="number" name="허리둘레">
                        </p>
                        <p>
                            <a href="#" class="size_search">사이즈 찾기</a>
                        </p>
                    </div>
                    <div class="fit">
                        <p>고객님에게 맞는 사이즈 : </p>
            ...
            <div class="collapse-item">
                <span><a href="QnA.jsp">Q&A</a></span>
            </div>
        </div>
    </div>

    <div id="footer">
        <a href="ShoppingCart.jsp">쇼핑백담기</a>
        <a href="Payment.jsp">바로주문</a>
    </div>

    <script src="http://code.jquery.com/jquery-3.2.1.min.js"></script>
    <script type="text/javascript">
        $(function() {
            $(".heart_none").click(function() {
                $(".heart").toggle();
                $(".heart_none").toggle();
            });
